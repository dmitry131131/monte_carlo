...
// Create separated process which will record machine data during benchmark
...
//  There may be problem with synchronizing machine clock and benchmark events
...
// Use thermal_zone dir only in linux. Disable temperature monitoring in other OS
